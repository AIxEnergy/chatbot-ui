...
AS $$
DECLARE
  project_url TEXT := 'https://ofaafmgrwrpyifqayqix.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9mYWFmbWdyd3JweWlmcWF5cWl4Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc0ODU1NDgwNSwiZXhwIjoyMDY0MTMwODA1fQ.QJ4VO70gQ6k5CWETgwlyvr3A1m6yzMVHe9pMJV8Wvwg'; -- full access needed for http request to storage
